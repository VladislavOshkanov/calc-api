...
pub async fn calculate_coefficient(
    ...
    let place_coeff = place_doc["coefficent"] // Обратите внимание на опечатку в модели Place
        .as_f64()
    ...
    let power_coeff = power_doc["coefficent"] // Обратите внимание на опечатку в модели Power
        .as_f64()
